    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="mb-8 flex flex-col gap-3">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Quản lý Tài liệu</h2>
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            {docs.length === 0 ? (
              ...
              docs.map((d, idx) => (
                <div key={d.id} className="bg-white rounded-lg shadow p-4 sm:p-6">
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        <p className="font-semibold text-gray-900 break-words">{d.original_name}</p>
